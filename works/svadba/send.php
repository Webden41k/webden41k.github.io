<?php
    ...
    $message = "Имя: $name | Телефон: $email"; // Формируем сообщение, отправляемое на почту

    $text = ('Обратный звонок' .PHP_EOL. 'Имя: '.$_GET['name']) .PHP_EOL. ('Телефон: '. $_GET['phone']);
	...
	$subject = "Обратный звонок с сайта svadba-v-sosnax "; // Задаем тему письма
